...
import { UploadCloud, BarChart3, DatabaseZap, Settings, LogOut, ShieldCheck, Users, Database, ClipboardCheck } from 'lucide-react';
...
export default function AdminSidebar() {
  ...
  return (
    <div className="w-64 bg-gray-900 text-white min-h-screen flex flex-col fixed inset-y-0 right-0 z-50">
      <div className="p-6 flex items-center gap-3 border-b border-gray-800">
        <div className="w-10 h-10 bg-green-600 rounded-lg flex items-center justify-center text-white font-bold shadow-lg">
          <ShieldCheck size={24} />
        </div>
